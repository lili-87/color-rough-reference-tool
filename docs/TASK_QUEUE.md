...
- [x] Phase 9.4: Add beginner-friendly workflow mismatch messages if ComfyUI accepts a prompt but the workflow ignores the image input.
...
- [x] Phase 10.8: Copy finished hand reference images into `project_output/hand_refs/`.
- [x] Phase 10.9: Refresh hand reference thumbnails after copied outputs are available.
