...
Phase 10.4:
Added minimal copying for completed prediction images reported by ComfyUI history into `project_output/predictions/`.
...
Phase 10.5:
Refresh prediction thumbnails after copied outputs are available.
