...
Phase 10.5:
Added minimal UI refresh handling for prediction thumbnails after copied outputs are available.
...
Phase 10.6:
Store the latest hand reference prompt ID after queueing.
